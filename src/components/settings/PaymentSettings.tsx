...
export function PaymentSettings({ companyProfile }: PaymentSettingsProps) {
  ...
  // États pour la connexion Stripe
  ...
  // Gestion de la connexion Stripe
  ...
  // Message si le profil n'existe pas encore
  const NoProfileMessage = () => (
    <div className="text-center py-8">
      <p className="text-muted-foreground">
        Vous devez d'abord créer un profil avant de configurer les paiements.
      </p>
      <Button 
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>Configurez les moyens de paiement et connectez votre compte Stripe</CardDescription>
        </CardHeader>
        <CardContent>
          <NoProfileMessage />
        </CardContent>
    ...
    <div className="space-y-8">
      <Tabs defaultValue="methods" className="w-full">
        <TabsList className="mb-4">
          ...
          <TabsTrigger value="stripe">Compte Stripe</TabsTrigger>
        </TabsList>
        
        <TabsContent value="methods">
          <Card>
            <CardHeader>
              <CardTitle>Moyens de paiement proposés</CardTitle>
              <CardDescription>
                Définissez les méthodes de paiement que vous proposez habituellement sur vos factures
              </CardDescription>
            </CardHeader>
            <CardContent>
